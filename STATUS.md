...
1. Product `a2e223c` has an extracted production runner, one pre-context shared
   ...
   remains fail closed. The 258-test local preflight,
...
2. Hierarchical per-attacker/per-blocker contexts and single-construction
   ...
   verified at final hash `14097481066362770282`, while the refreshed 1-4 ms
   ladder measures approximately 1.4-4.7 ms p95 instead of the former 240-266
