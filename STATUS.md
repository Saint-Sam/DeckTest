...
Generated: 2026-07-11T22:52:08.575818+00:00 by `tools/write_card_maturity.py`
...
| --- | ---: |
| Absent identity-bound definition evidence | 22,143 |
| Parsed | 0 |
| Mapped partial | 0 |
| Structurally translated | 0 |
| Compiler valid | 10,649 |
...
Compiler-valid evidence currently reaches 10,649/32,792
in-v1 identities (32.4744%). This includes the
...
| Compiler-valid translated legacy definitions | 10,587 |
| Fail-closed quarantined legacy definitions | 22,703 |
| Structurally tested legacy ability uses | 18,466/43,649 |
| Quarantined legacy ability uses | 25,183 |
| Owner-priority compiler-valid definitions | 187/365 |
...
`0a09788a678788ba901c37aefbaef8eb44d83d440db5cbbd174797f0cbe5a337`).
