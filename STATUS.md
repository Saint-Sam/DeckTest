...
1. Product `f8fbb4f` has an extracted production runner, one pre-context shared
   ...
   Ordinary triggered targets now use the same canonical human, AI, telemetry,
   and replay path; required no-legal-target suppression remains fail closed.
   The 245-test local preflight,
