...
Generated: 2026-07-13T03:02:55.185338+00:00 by `tools/write_card_maturity.py`
...
| --- | ---: |
| Absent identity-bound definition evidence | 15,803 |
| Parsed | 0 |
| Mapped partial | 0 |
| Structurally translated | 0 |
| Compiler valid | 16,989 |
...
Compiler-valid evidence currently reaches 16,989/32,792
in-v1 identities (51.8084%). This includes the
...
| Compiler-valid translated legacy definitions | 16,941 |
| Fail-closed quarantined legacy definitions | 16,349 |
| Structurally tested legacy ability uses | 27,240/43,649 |
| Quarantined legacy ability uses | 16,409 |
| Owner-priority compiler-valid definitions | 233/365 |
...
`d61aeeb296af18162b4004cd43480e000b92e81fa670d151f25240657c043448`).
